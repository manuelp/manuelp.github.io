...
Uno dei più grandi "presentatori" contemporanei, [Damian Conway](http://damian.conway.org/),  un *minimo di 20 ore di preparazione per ogni ora di presentazione*. Questo ovviamente se si vuole fare un talk **memorabile**...
